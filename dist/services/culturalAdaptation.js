...
exports.culturalAdaptationService = exports.CulturalAdaptationService = void 0;
class CulturalAdaptationService {
     ...
     */
    adaptToCulture(culturalProfile, userPreferences) {
     ...
     */
    isSensitiveTopic(topic, culturalProfile) {
     ...
     */
    adaptFormality(message, formalityLevel) {
     ...
     */
    generateAdaptationGuidelines(culturalProfile, userPreferences) {
     ...
     */
    detectCulturalProfile(userLanguage, userRegion) {
        ...
        if (['es', 'pt'].includes(userLanguage))
            return 'latin_american';
        if (['ar', 'fa', 'he'].includes(userLanguage))
            return 'middle_eastern';
        if (['zh', 'ja', 'ko'].includes(userLanguage))
            return 'east_asian';
        if (['hi', 'ur', 'bn', 'ta'].includes(userLanguage))
            return 'south_asian';
        return 'western'; // Default
    }
}
exports.CulturalAdaptationService = CulturalAdaptationService;
// Export singleton instance
exports.culturalAdaptationService = new CulturalAdaptationService();
